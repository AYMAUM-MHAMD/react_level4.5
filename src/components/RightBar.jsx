...
const RightBar = ({theme}) => {
  return (
    <Box sx={{ minWidth: "516px", flexGrow: "auto", bgcolor: theme.palette.favColor.main, display: showLG }} pl={2} component="section">
      <Box sx={{position: "fixed", right: "0",}}>
        <Typography sx={{ fontWeight: 300 }} mt={2} variant="h6">
          Online Frinds
        </Typography>
        <AvatarGroup sx={{ my: 2, justifyContent: "center" }} total={24}>
          <Avatar
        ...
        <ImageList
        gap={10}
          sx={{ width: 500, height: 164, overflowY: "hidden" }}
          cols={3}
          rowHeight={164}
        >
          {itemData.map((item) => (
        ...
        <Typography sx={{ fontWeight: 300 }} mt={4} mb={1} variant="h6">
          Latest Conversation
        </Typography>
