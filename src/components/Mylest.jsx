...
const MyLest = ({ theme, setmyMOde, showList, setshowList }) => {
  const myList = [
  ...
  return (
    ...
    >
      <List sx={{ position: "fixed" }}>
        ...
        <ListItem sx={{alignItems: "flex-end"}} disablePadding>
          <ListItemIcon>
            <MaterialUISwitch
              onChange={() => {
          ...
          <ListItemText sx={{textTransform: "capitalize", marginBottom: "4px"}} primary={`${theme.palette.mode} mode`} />
        </ListItem>
      </List>
    </Box>
  );
